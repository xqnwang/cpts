...
\makeatother
\usepackage{xcolor}
\usepackage[top=2.5cm,bottom=2.5cm,left=2.5cm,right=2.5cm,left=2cm,right=2cm]{geometry}
...
\nocover
  ...
  \addresses{%
   ...
   \lfoot{\sf Wang, Hyndman: 14 October 2024}
...
propose weighting the nonconformity scores (for example, prediction
...
e.g., \textcite{schlembach2022} and \textcite{sun2022}.
...
byEquation \eqref{eq-acmcp}. Following \textcite{angelopoulos2024}, we
