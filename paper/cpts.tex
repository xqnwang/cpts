...
\hypersetup{
  ...
  pdfkeywords={Conformal prediction, Distribution-free
inference, Nonexchangeability, Valid prediction interval, Weighted
quantile estimate},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
% Authors
  ...
  \addresses{%
   ...
   \lfoot{\sf Wang, Hyndman: 4 June 2024}
...
\(n = 5000, nfit = ncal = 500, \alpha = 0.1, H = 3\).
...
\caption{\label{fig-AR2_cov}Data simulated from an AR(2) model}
...
\caption{\label{fig-AR2_box}Data simulated from an AR(2) model}
...
\caption{\label{fig-AR2_timeplot}Data simulated from an AR(2) model}
...
\(n = 2000, nfit = ncal = 500, \alpha = 0.1, H = 3\).
...
\caption{\label{fig-NL_cov}Data simulated from a nonlinear model}
...
\caption{\label{fig-NL_box}Data simulated from a nonlinear model}
...
\includegraphics{cpts_files/figure-pdf/fig-NL_timeplot-1.pdf}

}

\caption{\label{fig-NL_timeplot}Data simulated from a nonlinear model}
...
Daily electricity demand in 2012--2014, Victoria, Australia

\begin{itemize}
\item
  \(H=7, \alpha=0.1, nfit = 2 \text{ years}, ncal = 100\)
\item
  temperature, workday, cooling (18)
\end{itemize}
...
maximum daily temperatures in 2012--2014, Victoria, Australia.}
...
\caption{\label{fig-elec_cov}Daily electricity demand}
...
\caption{\label{fig-elec_box}Daily electricity demand}
...
\caption{\label{fig-elec_timeplot}Daily electricity demand}
...
\item
  NSWprice: New South Wales electricity price, normalized between 0 and
  1
\item
  NSWdemand: New South Wales electricity demand, normalized between 0
  and 1
\item
