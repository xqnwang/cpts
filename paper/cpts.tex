...
\nocover
  ...
  \addresses{%
   ...
   \lfoot{\sf Wang, Hyndman: 17 September 2024}
...
\item
  Applications: \textcite{shafer2008}, \textcite{lei2014},
  \textcite{chernozhukov2018}, \textcite{tibshirani2019},
  \textcite{lei2021}, \textcite{guan2022}, \textcite{guan2023},
  \textcite{oliveira2024}
\end{itemize}

Background: Development and popularity of conformal prediction

Brief literature review of conformal prediction methods or applications
on time series data.: \textcite{stankeviciute2021}, \textcite{xu2021},
\textcite{yu2022}, \textcite{schlembach2022}, \textcite{xu2023},
\textcite{yang2024}

Challenges and limitations: Multi-step conformal prediction.
...
prediction methods described in \textbf{?@sec-review\_reg} to deal with
multi-step time series forecasting. Finally, we explore the properties
of forecast errors for optimal multi-step forecasts, and then propose
the \textbf{autocorrelated multi-step conformal prediction} (AcMCP)
method to account for the serial correlation of multi-step forecast
errors.
...
nonconformity score vectors when exchangeability is violated.
...
specific instance of Equation~\ref{eq-acmcp_1}, thereby ensuring
long-run coverage for each individual forecast horizon \(h\).
