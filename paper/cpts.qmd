...
When $h=1$, @cor-cov_qt reduces to Proposition 1 of @angelopoulos2024, while @cor-cov_qt extends this result to a more general multi-step setting and establishes an explicit upper bound on the coverage gap for multi-step forecasting.
