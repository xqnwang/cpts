...
the online learning framework with sequential splits is also illustrated in @fig-flowchart. This framework updates prediction intervals as new data points arrive, allowing us to assess their long-run coverage behaviour. It adopts a standard rolling window evaluation strategy, although expanding windows could easily be used instead.
