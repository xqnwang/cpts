...
The integrator used in the paper is $r_t(x)=K_{\mathrm{I}} \tan \left(x \log (t) /\left(t C_{\mathrm{sat}}\right)\right)$, where $C_{\mathrm{sat}}$ controls the guaranteed coverage, and $K_{\mathrm{I}}$ controls the change scale of the integrator.
